...
import {
  ...
  instanceIndex, sin, abs, max, length, fract, dot, floor, mix, If, cameraPosition,
} from 'three/tsl';
 ...
 */
export function makeModelMaterial(src = {}, foliage = false) {
  ...
  mat.userData.gpuName = src.name || (foliage ? 'foliage' : 'model');
  return mat;
}
